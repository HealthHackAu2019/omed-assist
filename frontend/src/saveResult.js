...
const createPayload = (result) => {
  return {
    "fields": {
      ...
      "depression_1": nullableIntToString(result.conditions.depression[0]),
      "depression_2": nullableIntToString(result.conditions.depression[1]),
      "depression_3": nullableIntToString(result.conditions.depression[2]),
      "depression_4": nullableIntToString(result.conditions.depression[3]),
      "depression_5": nullableIntToString(result.conditions.depression[4]),
      "depression_6": nullableIntToString(result.conditions.depression[5]),
      "depression_7": nullableIntToString(result.conditions.depression[6]),
